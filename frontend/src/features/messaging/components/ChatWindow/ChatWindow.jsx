...
import { FiArrowLeft, FiSearch, FiCheckSquare, FiStar, FiDownload, FiTrash2, FiBellOff, FiUserX } from "react-icons/fi";
...
export default function ChatWindow({
    ...
    const starredMessagesRef = useRef(null);
    ...
    useEffect(() => {
        const handleOutsideClick = (event) => {
            ...
            if (
                starredMessagesRef.current &&
                !starredMessagesRef.current.contains(event.target)
            ) {
    ...
    }, [setShowChatMenu, setShowStarredMessages]);
        ...
        <>
                ...
                <div className="chatHeaderMenu" ref={chatMenuRef}>
                    ...
                    {showChatMenu && (
                        <div className="chatMenuDropdown">
                            ...
                            <button type="button" onClick={handleToggleMute}> <FiBellOff />{mutedUsers.some((id) => String(id) === String(selectedUser?._id)) ? "Unmute" : "Mute"}</button>
            ...
            {showStarredMessages && (
                <div className="starredMessagesOverlay">
                    <div
                        className="starredMessagesPanel"
                        ref={starredMessagesRef}
                    >
